...
\begin{figure}[h]
  ...
  \caption{A 24-part sample drawn across CadQuarry's eleven part families. Every
...
standard designation. Their seeded \emph{selection} and dedup are stable like any
other family; only the exact solver output is platform-dependent
(\cref{sec:uses}).
