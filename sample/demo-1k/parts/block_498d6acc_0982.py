...
# Generated by CadQuarry v0.1.0 — seed 1234004684 — CC0-1.0
...
PARAMS = {
    ...
    "boss_bore_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 6.0, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.09388892402001492)
    return result
