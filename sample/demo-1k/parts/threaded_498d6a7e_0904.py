...
# Generated by CadQuarry v0.6.0 — seed 1234004606 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 26.2, "min": 10.5, "max": 52.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
