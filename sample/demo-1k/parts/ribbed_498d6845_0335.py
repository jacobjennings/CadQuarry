...
# Generated by CadQuarry v0.3.0 — seed 1234004037 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 26.2, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 14.2, "min": 5.7, "max": 28.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
