...
# Generated by CadQuarry v0.3.0 — seed 1234004032 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 32.6, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 55.19, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
