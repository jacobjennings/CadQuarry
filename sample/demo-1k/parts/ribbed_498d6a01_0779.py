...
# Generated by CadQuarry v0.4.0 — seed 1234004481 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 68.1, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 10.6, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
