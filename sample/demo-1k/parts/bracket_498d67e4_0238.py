...
# Generated by CadQuarry v0.3.0 — seed 1234003940 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 26.3, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 17.5, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.0, "min": 3.0, "max": 8.8, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
