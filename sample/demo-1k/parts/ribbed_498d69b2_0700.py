...
# Generated by CadQuarry v0.1.0 — seed 1234004402 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 74.74, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 55.9, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 5.0, "min": 2.0, "max": 10.0, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
