...
# Generated by CadQuarry v0.3.0 — seed 1234004583 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 10.1, "min": 2.0, "max": 13.1, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.11812822051089125)
    return result
