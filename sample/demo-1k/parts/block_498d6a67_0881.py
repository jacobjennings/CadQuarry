...
# Generated by CadQuarry v0.1.0 — seed 1234004583 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 82.1, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    ...
    "boss_h": {"type": 'float', "default": 11.8, "min": 4.7, "max": 29.5, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 12.2, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
