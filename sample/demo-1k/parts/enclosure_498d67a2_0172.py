...
# Generated by CadQuarry v0.5.0 — seed 1234003874 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 61.6, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 72.9, "min": 29.2, "max": 145.8, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
