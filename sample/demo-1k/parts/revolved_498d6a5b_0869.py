...
# Generated by CadQuarry v0.5.0 — seed 1234004571 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 39.67, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 133.4, "min": 40.0, "max": 320.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
