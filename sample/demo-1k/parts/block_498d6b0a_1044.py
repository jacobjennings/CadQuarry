...
# Generated by CadQuarry v0.4.0 — seed 1234004746 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 91.7, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.09020251065105377)
    return result
