...
# Generated by CadQuarry v0.1.0 — seed 1234004172 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 5.7, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.11325302327708978)
    return result
