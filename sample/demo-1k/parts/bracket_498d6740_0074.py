...
# Generated by CadQuarry v0.1.0 — seed 1234003776 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 73.33, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.9, "min": 2.5, "max": 15.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
