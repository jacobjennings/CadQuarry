...
# Generated by CadQuarry v0.1.0 — seed 1234004528 — CC0-1.0
...
PARAMS = {
    ...
    "rib_h": {"type": 'float', "default": 19.7, "min": 7.9, "max": 39.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
    "rib_t": {"type": 'float', "default": 2.2, "min": 1.0, "max": 5.5, "step": 0.5, "group": 'Ribs', "label": 'Rib thickness (mm)'},
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 8.5, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
