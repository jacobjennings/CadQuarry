...
# Generated by CadQuarry v0.1.0 — seed 1234004560 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 40.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 57.83, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.6, "min": 4.0, "max": 24.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
