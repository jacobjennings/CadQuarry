...
# Generated by CadQuarry v0.6.0 — seed 1234003980 — CC0-1.0
...
PARAMS = {
    ...
    "gear_w": {"type": 'float', "default": 16.6, "min": 6.6, "max": 41.5, "step": 1.0, "group": 'Gear', "label": 'Face width (mm)'},
    "bore_d": {"type": 'float', "default": 11.2, "min": 2.0, "max": 29.2, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
