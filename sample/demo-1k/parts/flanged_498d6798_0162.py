...
# Generated by CadQuarry v0.6.0 — seed 1234003864 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 30.2, "min": 9.1, "max": 75.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 12.6, "min": 2.0, "max": 21.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 66.6, "min": 39.0, "max": 90.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.0, "min": 1.2, "max": 12.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 8.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 20.0, "min": 13.3, "max": 30.0, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
