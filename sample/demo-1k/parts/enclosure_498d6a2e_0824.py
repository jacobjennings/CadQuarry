...
# Generated by CadQuarry v0.1.0 — seed 1234004526 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 46.4, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 94.1, "min": 37.6, "max": 188.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.07918499443076078)
    return result
