...
# Generated by CadQuarry v0.1.0 — seed 1234004498 — CC0-1.0
...
PARAMS = {
    ...
    "boss_h": {"type": 'float', "default": 9.2, "min": 3.7, "max": 23.0, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 9.7, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.0656493504937412)
    return result
