...
# Generated by CadQuarry v0.6.0 — seed 1234003779 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 45.2, "min": 18.1, "max": 90.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
