...
# Generated by CadQuarry v0.5.0 — seed 1234004384 — CC0-1.0
...
PARAMS = {
    ...
    "helix_angle": {"type": 'float', "default": 25.2, "min": 5.0, "max": 40.0, "step": 1.0, "group": 'Gear', "label": 'Helix angle (deg)'},
    ...
    "bore_d": {"type": 'float', "default": 8.3, "min": 2.0, "max": 31.9, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
