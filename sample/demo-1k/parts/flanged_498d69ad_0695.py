...
# Generated by CadQuarry v0.1.0 — seed 1234004397 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 127.4, "min": 38.2, "max": 318.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 27.8, "min": 2.0, "max": 63.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 201.9, "min": 117.0, "max": 270.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 8.7, "min": 2.6, "max": 51.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 6.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 60.6, "min": 40.4, "max": 90.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
