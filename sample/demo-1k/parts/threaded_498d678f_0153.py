...
# Generated by CadQuarry v0.6.0 — seed 1234003855 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 48.1, "min": 19.2, "max": 96.2, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
