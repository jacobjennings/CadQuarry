...
# Generated by CadQuarry v0.6.0 — seed 1234004727 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 24.54, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 14.0, "min": 4.2, "max": 35.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 10.4, "min": 2.0, "max": 17.2, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 57.7, "min": 31.9, "max": 73.6, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.3, "min": 1.0, "max": 5.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
