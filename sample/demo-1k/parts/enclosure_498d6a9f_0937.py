...
# Generated by CadQuarry v0.4.0 — seed 1234004639 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 42.44, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 21.5, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 22.8, "min": 9.1, "max": 45.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
