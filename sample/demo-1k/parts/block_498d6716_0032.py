...
# Generated by CadQuarry v0.3.0 — seed 1234003734 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 28.4, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 1.6, "min": 2.0, "max": 1.4, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
