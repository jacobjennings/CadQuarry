...
# Generated by CadQuarry v0.6.0 — seed 1234004550 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 42.8, "min": 17.1, "max": 85.6, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
