...
# Generated by CadQuarry v0.3.0 — seed 1234004007 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 27.59, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 90.4, "min": 27.1, "max": 271.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
