...
# Generated by CadQuarry v0.5.0 — seed 1234003997 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 22.01, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 11.9, "min": 4.0, "max": 11.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
