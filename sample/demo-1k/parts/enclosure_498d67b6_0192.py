...
# Generated by CadQuarry v0.3.0 — seed 1234003894 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 38.6, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 46.7, "min": 18.7, "max": 93.4, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
