...
# Generated by CadQuarry v0.4.0 — seed 1234004341 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 82.4, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 11.9, "min": 4.0, "max": 12.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
