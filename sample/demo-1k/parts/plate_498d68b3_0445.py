...
# Generated by CadQuarry v0.3.0 — seed 1234004147 — CC0-1.0
...
def build(p):
    ...
    result = (
        ...
        .rarray(8.0, 8.0, p["hole_nx"], p["hole_ny"])
        .hole(p["hole_d"])
    )
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.06995563943301412)
    return result
