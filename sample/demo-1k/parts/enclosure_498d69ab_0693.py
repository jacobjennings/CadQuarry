...
# Generated by CadQuarry v0.6.0 — seed 1234004395 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 70.4, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 73.0, "min": 29.2, "max": 146.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
