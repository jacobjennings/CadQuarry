...
# Generated by CadQuarry v0.1.0 — seed 1234004278 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 48.2, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 14.5, "min": 9.6, "max": 21.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
