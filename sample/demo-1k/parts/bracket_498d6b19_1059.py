...
# Generated by CadQuarry v0.1.0 — seed 1234004761 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 71.11, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 66.5, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 10.5, "min": 4.0, "max": 22.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
