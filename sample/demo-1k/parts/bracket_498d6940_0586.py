...
# Generated by CadQuarry v0.1.0 — seed 1234004288 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 50.72, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 4.5, "min": 2.5, "max": 15.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
