...
# Generated by CadQuarry v0.4.0 — seed 1234004177 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 29.63, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 13.2, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 8.9, "min": 5.9, "max": 13.3, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
