...
# Generated by CadQuarry v0.4.0 — seed 1234003931 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 25.9, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 28.1, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 22.7, "min": 9.1, "max": 36.3, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 18.6, "min": 7.4, "max": 29.8, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 4.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 4.1, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
