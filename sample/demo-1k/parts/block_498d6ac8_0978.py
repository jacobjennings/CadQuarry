...
# Generated by CadQuarry v0.6.0 — seed 1234004680 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 93.02, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    "block_d": {"type": 'float', "default": 52.9, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 27.9, "min": 18.6, "max": 41.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
