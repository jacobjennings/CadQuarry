...
# Generated by CadQuarry v0.1.0 — seed 1234004446 — CC0-1.0
...
PARAMS = {
    ...
    "boss_d": {"type": 'float', "default": 23.2, "min": 11.6, "max": 46.4, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 5.8, "min": 2.3, "max": 14.5, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 16.2, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
