...
# Generated by CadQuarry v0.1.0 — seed 1234004497 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 51.3, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
