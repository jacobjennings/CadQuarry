...
# Generated by CadQuarry v0.6.0 — seed 1234004667 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 43.3, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 15.4, "min": 6.2, "max": 30.8, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
