...
# Generated by CadQuarry v0.3.0 — seed 1234003806 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 45.3, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 29.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
