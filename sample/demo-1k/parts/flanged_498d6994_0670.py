...
# Generated by CadQuarry v0.6.0 — seed 1234004372 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 83.03, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 54.3, "min": 16.3, "max": 135.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 43.3, "min": 2.0, "max": 58.1, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 162.9, "min": 107.9, "max": 249.1, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 12.6, "min": 3.8, "max": 21.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
