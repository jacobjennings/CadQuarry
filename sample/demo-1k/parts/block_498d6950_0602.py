...
# Generated by CadQuarry v0.6.0 — seed 1234004304 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 16.4, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 30.6, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 3.8, "min": 2.0, "max": 4.8, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
