...
# Generated by CadQuarry v0.4.0 — seed 1234003937 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 63.2, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body depth (mm)'},
    ...
    "port_r": {"type": 'float', "default": 5.0, "min": 2.5, "max": 8.9, "step": 1.0, "group": 'Ports', "label": 'Ports circumradius (mm)'},
    "port_len": {"type": 'float', "default": 8.6, "min": 2.0, "max": 24.3, "step": 1.0, "group": 'Ports', "label": 'Port boss length (mm)'},
    "port_bore": {"type": 'float', "default": 3.5, "min": 2.0, "max": 5.8, "step": 0.5, "group": 'Ports', "label": 'Port bore diameter (mm)'},
