...
# Generated by CadQuarry v0.3.0 — seed 1234004235 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 66.0, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 67.3, "min": 20.2, "max": 201.9, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 22.5, "min": 2.0, "max": 46.2, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 127.2, "min": 79.2, "max": 198.0, "step": 1.0, "group": 'Body', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 19.9, "min": 6.0, "max": 33.6, "step": 0.5, "group": 'Body', "label": 'Flange height (mm)'},
