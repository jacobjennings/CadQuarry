...
# Generated by CadQuarry v0.1.0 — seed 1234004694 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 98.5, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 7.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "boss_d": {"type": 'float', "default": 21.0, "min": 10.5, "max": 42.0, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 11.5, "min": 4.6, "max": 28.8, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 10.5, "min": 2.0, "max": 14.7, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
