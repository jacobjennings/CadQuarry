...
# Generated by CadQuarry v0.4.0 — seed 1234003759 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 39.8, "min": 25.0, "max": 160.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "col_r": {"type": 'float', "default": 6.6, "min": 3.3, "max": 9.9, "step": 1.0, "group": 'Column', "label": 'Column circumradius (mm)'},
    "col_h": {"type": 'float', "default": 35.6, "min": 10.7, "max": 106.8, "step": 1.0, "group": 'Column', "label": 'Column height (mm)'},
