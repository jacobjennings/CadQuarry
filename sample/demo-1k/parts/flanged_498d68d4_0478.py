...
# Generated by CadQuarry v0.6.0 — seed 1234004180 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 40.62, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 43.3, "min": 13.0, "max": 108.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 13.0, "min": 2.0, "max": 28.4, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 70.4, "min": 52.8, "max": 121.9, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.4, "min": 1.0, "max": 17.3, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
