...
# Generated by CadQuarry v0.6.0 — seed 1234003745 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 61.0, "min": 24.4, "max": 122.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
