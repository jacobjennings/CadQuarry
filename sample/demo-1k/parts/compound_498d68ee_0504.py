...
# Generated by CadQuarry v0.6.0 — seed 1234004206 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 51.1, "min": 25.0, "max": 160.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    "base_h": {"type": 'float', "default": 10.0, "min": 3.0, "max": 30.0, "step": 0.5, "group": 'Base', "label": 'Base thickness (mm)'},
    "col_d": {"type": 'float', "default": 10.0, "min": 4.0, "max": 25.6, "step": 1.0, "group": 'Column', "label": 'Column diameter (mm)'},
    "col_h": {"type": 'float', "default": 30.1, "min": 9.0, "max": 90.3, "step": 1.0, "group": 'Column', "label": 'Column height (mm)'},
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 11.5, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
