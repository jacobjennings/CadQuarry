...
# Generated by CadQuarry v0.1.0 — seed 1234003764 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 59.7, "min": 17.9, "max": 149.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 23.7, "min": 2.0, "max": 31.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 83.0, "min": 58.5, "max": 135.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 7.2, "min": 2.2, "max": 23.9, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 8.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 24.9, "min": 16.6, "max": 37.4, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
