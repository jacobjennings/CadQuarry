...
# Generated by CadQuarry v0.3.0 — seed 1234003716 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 33.49, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 16.9, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 14.1, "min": 5.6, "max": 28.2, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
