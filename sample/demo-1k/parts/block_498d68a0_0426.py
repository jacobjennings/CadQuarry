...
# Generated by CadQuarry v0.1.0 — seed 1234004128 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 30.96, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    "block_d": {"type": 'float', "default": 15.0, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 57.0, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 9.3, "min": 6.2, "max": 13.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
    ...
    "boss_bore_d": {"type": 'float', "default": 10.5, "min": 2.0, "max": 16.7, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
