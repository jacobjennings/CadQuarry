...
# Generated by CadQuarry v0.3.0 — seed 1234004725 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 29.4, "min": 8.8, "max": 73.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 17.4, "min": 2.0, "max": 28.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 75.5, "min": 52.0, "max": 120.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.8, "min": 1.4, "max": 11.8, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 22.6, "min": 15.1, "max": 34.0, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
