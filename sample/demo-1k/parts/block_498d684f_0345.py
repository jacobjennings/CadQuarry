...
# Generated by CadQuarry v0.3.0 — seed 1234004047 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 44.4, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 74.4, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 7.7, "min": 2.0, "max": 13.0, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
