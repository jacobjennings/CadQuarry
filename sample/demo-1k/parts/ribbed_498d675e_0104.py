...
# Generated by CadQuarry v0.6.0 — seed 1234003806 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 73.9, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 7.9, "min": 3.2, "max": 15.8, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
