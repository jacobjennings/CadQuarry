...
# Generated by CadQuarry v0.5.0 — seed 1234003806 — CC0-1.0
...
PARAMS = {
    ...
    "tab_a": {"type": 'float', "default": 45.7, "min": 18.3, "max": 73.1, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 36.5, "min": 14.6, "max": 58.4, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 5.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 8.0, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
