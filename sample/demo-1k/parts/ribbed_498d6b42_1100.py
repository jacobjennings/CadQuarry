...
# Generated by CadQuarry v0.3.0 — seed 1234004802 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 81.6, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 10.9, "min": 4.4, "max": 21.8, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
