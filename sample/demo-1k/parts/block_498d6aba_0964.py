...
# Generated by CadQuarry v0.4.0 — seed 1234004666 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 66.4, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    ...
    "pocket_w": {"type": 'float', "default": 49.3, "min": 24.6, "max": 60.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 40.9, "min": 20.4, "max": 53.1, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 25.9, "min": 10.4, "max": 47.4, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
