...
# Generated by CadQuarry v0.1.0 — seed 1234004650 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 21.42, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 3.7, "min": 2.0, "max": 10.7, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
