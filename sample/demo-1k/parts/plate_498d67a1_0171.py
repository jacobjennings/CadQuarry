...
# Generated by CadQuarry v0.3.0 — seed 1234003873 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 103.64, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 68.0, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
...
def build(p):
    ...
    result = (
        ...
        .rarray(82.9, 54.4, p["hole_nx"], p["hole_ny"])
        .hole(p["hole_d"])
    )
    return result
