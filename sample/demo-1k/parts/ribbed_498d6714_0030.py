...
# Generated by CadQuarry v0.1.0 — seed 1234003732 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 91.58, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 80.2, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 19.9, "min": 8.0, "max": 39.8, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
