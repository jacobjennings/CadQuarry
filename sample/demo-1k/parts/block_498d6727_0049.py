...
# Generated by CadQuarry v0.1.0 — seed 1234003751 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 26.4, "min": 13.2, "max": 46.5, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 15.5, "min": 7.8, "max": 28.6, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 11.8, "min": 4.7, "max": 31.2, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
