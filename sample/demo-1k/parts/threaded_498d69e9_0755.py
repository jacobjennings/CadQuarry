...
# Generated by CadQuarry v0.6.0 — seed 1234004457 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 56.9, "min": 22.8, "max": 113.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
