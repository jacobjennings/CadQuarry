...
# Generated by CadQuarry v0.3.0 — seed 1234004304 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 12.29, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 9.4, "min": 2.8, "max": 28.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "flange_d": {"type": 'float', "default": 17.4, "min": 14.7, "max": 36.9, "step": 1.0, "group": 'Body', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 2.5, "min": 0.8, "max": 4.7, "step": 0.5, "group": 'Body', "label": 'Flange height (mm)'},
