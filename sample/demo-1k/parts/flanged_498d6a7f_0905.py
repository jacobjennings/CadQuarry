...
# Generated by CadQuarry v0.3.0 — seed 1234004607 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 46.9, "min": 14.1, "max": 117.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 26.7, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 93.2, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 5.9, "min": 1.8, "max": 18.8, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 6.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 28.0, "min": 18.6, "max": 41.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
