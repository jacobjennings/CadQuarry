...
# Generated by CadQuarry v0.6.0 — seed 1234004129 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 47.5, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 84.6, "min": 33.8, "max": 169.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
