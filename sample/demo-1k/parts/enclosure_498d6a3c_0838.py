...
# Generated by CadQuarry v0.3.0 — seed 1234004540 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 36.97, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 15.0, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 33.6, "min": 13.4, "max": 67.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
