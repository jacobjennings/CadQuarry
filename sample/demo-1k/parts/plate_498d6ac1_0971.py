...
# Generated by CadQuarry v0.3.0 — seed 1234004673 — CC0-1.0
...
PARAMS = {
    ...
    "plate_d": {"type": 'float', "default": 45.7, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.08931936348956979)
    return result
