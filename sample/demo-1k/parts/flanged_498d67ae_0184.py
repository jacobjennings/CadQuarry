...
# Generated by CadQuarry v0.1.0 — seed 1234003886 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 17.8, "min": 2.0, "max": 38.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 119.5, "min": 71.5, "max": 165.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 5.1, "min": 1.5, "max": 18.9, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
