...
# Generated by CadQuarry v0.6.0 — seed 1234004212 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 41.7, "min": 12.5, "max": 104.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 21.3, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 89.6, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.1, "min": 1.2, "max": 16.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
