...
# Generated by CadQuarry v0.4.0 — seed 1234003972 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 34.9, "min": 10.5, "max": 87.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 18.9, "min": 2.0, "max": 28.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 86.1, "min": 52.0, "max": 120.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.3, "min": 1.3, "max": 14.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
