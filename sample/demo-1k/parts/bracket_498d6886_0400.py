...
# Generated by CadQuarry v0.1.0 — seed 1234004102 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 40.0, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 22.7, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 6.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 9.1, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
