...
# Generated by CadQuarry v0.4.0 — seed 1234004084 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 84.4, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 71.0, "min": 28.4, "max": 113.6, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 47.8, "min": 19.1, "max": 76.5, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 6.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 10.5, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
