...
# Generated by CadQuarry v0.4.0 — seed 1234004179 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 43.2, "min": 13.0, "max": 108.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 23.5, "min": 2.0, "max": 38.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 130.5, "min": 71.5, "max": 165.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.9, "min": 1.5, "max": 17.3, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 5.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 39.1, "min": 26.1, "max": 58.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
