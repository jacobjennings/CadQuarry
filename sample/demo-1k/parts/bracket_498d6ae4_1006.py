...
# Generated by CadQuarry v0.3.0 — seed 1234004708 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 35.8, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 53.0, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
