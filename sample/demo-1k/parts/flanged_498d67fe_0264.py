...
# Generated by CadQuarry v0.4.0 — seed 1234003966 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 24.3, "min": 2.0, "max": 42.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 122.4, "min": 78.0, "max": 180.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 10.1, "min": 3.0, "max": 15.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 36.7, "min": 24.5, "max": 55.1, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
