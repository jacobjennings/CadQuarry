...
# Generated by CadQuarry v0.4.0 — seed 1234004236 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 10.4, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 24.7, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 2.6, "min": 2.0, "max": 3.0, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
