...
# Generated by CadQuarry v0.3.0 — seed 1234004648 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 77.6, "min": 23.3, "max": 194.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 29.9, "min": 2.0, "max": 42.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 108.1, "min": 78.0, "max": 180.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 5.0, "min": 1.5, "max": 31.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 5.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 32.4, "min": 21.6, "max": 48.6, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
