...
# Generated by CadQuarry v0.6.0 — seed 1234004110 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 110.61, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 78.3, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 83.9, "min": 33.6, "max": 167.8, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.08715892411495059)
    return result
