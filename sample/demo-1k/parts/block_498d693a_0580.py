...
# Generated by CadQuarry v0.1.0 — seed 1234004282 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 29.2, "min": 14.6, "max": 48.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 18.5, "min": 9.2, "max": 25.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 47.2, "min": 18.9, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.10574487689389361)
    return result
