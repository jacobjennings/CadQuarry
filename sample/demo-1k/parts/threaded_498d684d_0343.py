...
# Generated by CadQuarry v0.6.0 — seed 1234004045 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 36.9, "min": 14.8, "max": 73.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
