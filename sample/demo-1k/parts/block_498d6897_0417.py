...
# Generated by CadQuarry v0.6.0 — seed 1234004119 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 33.8, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    ...
    "pocket_w": {"type": 'float', "default": 43.2, "min": 21.6, "max": 56.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 23.6, "min": 11.8, "max": 27.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 53.1, "min": 21.2, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.07466662016939457)
    return result
