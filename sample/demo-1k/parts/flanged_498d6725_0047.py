...
# Generated by CadQuarry v0.3.0 — seed 1234003749 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 18.7, "min": 5.6, "max": 46.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 7.7, "min": 2.0, "max": 17.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 46.3, "min": 32.5, "max": 75.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.4, "min": 1.0, "max": 7.5, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
