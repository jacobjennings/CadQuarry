...
# Generated by CadQuarry v0.6.0 — seed 1234004214 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 57.0, "min": 22.8, "max": 114.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
