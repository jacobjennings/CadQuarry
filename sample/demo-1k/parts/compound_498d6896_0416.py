...
# Generated by CadQuarry v0.4.0 — seed 1234004118 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 30.8, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 50.7, "min": 20.3, "max": 81.1, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 17.0, "min": 6.8, "max": 27.2, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 8.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 3.7, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
