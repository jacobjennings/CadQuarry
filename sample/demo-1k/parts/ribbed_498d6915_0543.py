...
# Generated by CadQuarry v0.4.0 — seed 1234004245 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 36.52, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 24.1, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 19.1, "min": 7.6, "max": 38.2, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
