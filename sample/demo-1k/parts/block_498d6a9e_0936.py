...
# Generated by CadQuarry v0.1.0 — seed 1234004638 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 54.2, "min": 27.1, "max": 64.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 40.4, "min": 20.2, "max": 48.2, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 38.6, "min": 15.4, "max": 67.4, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
