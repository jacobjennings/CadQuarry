...
# Generated by CadQuarry v0.6.0 — seed 1234004355 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 56.2, "min": 22.5, "max": 112.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
