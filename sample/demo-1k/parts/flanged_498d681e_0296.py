...
# Generated by CadQuarry v0.4.0 — seed 1234003998 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 121.2, "min": 36.4, "max": 303.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 29.2, "min": 2.0, "max": 63.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 159.4, "min": 117.0, "max": 270.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 11.4, "min": 3.4, "max": 48.5, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
