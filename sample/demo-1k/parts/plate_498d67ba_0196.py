...
# Generated by CadQuarry v0.6.0 — seed 1234003898 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 99.39, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 50.7, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 29.8, "min": 19.9, "max": 44.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
    "n_bolts": {"type": 'int', "default": 4, "min": 3, "max": 12, "step": 1, "group": 'Holes', "label": 'Number of bolts'},
    "chamfer_d": {"type": 'float', "default": 2.9, "min": 2.0, "max": 6.1, "step": 0.5, "group": 'Body', "label": 'Chamfer distance (mm)'},
