...
# Generated by CadQuarry v0.6.0 — seed 1234004017 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 27.1, "min": 10.8, "max": 54.2, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
