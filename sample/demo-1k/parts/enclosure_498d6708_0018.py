...
# Generated by CadQuarry v0.6.0 — seed 1234003720 — CC0-1.0
...
PARAMS = {
    ...
    "enc_h": {"type": 'float', "default": 26.3, "min": 10.5, "max": 52.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
    "wall_t": {"type": 'float', "default": 3.0, "min": 2.0, "max": 6.0, "step": 0.5, "group": 'Body', "label": 'Wall thickness (mm)'},
    "hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 8.4, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.06057830461662578)
    return result
