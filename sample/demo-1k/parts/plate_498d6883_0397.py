...
# Generated by CadQuarry v0.3.0 — seed 1234004099 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 95.76, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 28.7, "min": 19.2, "max": 43.1, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.05399295003984077)
    return result
