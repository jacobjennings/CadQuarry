...
# Generated by CadQuarry v0.6.0 — seed 1234003799 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 52.9, "min": 21.2, "max": 105.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
