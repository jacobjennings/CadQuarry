...
# Generated by CadQuarry v0.4.0 — seed 1234004297 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 92.2, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "pocket_w": {"type": 'float', "default": 32.8, "min": 16.4, "max": 56.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 29.0, "min": 14.5, "max": 54.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 54.1, "min": 21.6, "max": 78.4, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
