...
# Generated by CadQuarry v0.6.0 — seed 1234004609 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 69.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 11.8, "min": 4.7, "max": 23.6, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
