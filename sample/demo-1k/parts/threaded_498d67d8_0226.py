...
# Generated by CadQuarry v0.6.0 — seed 1234003928 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 37.0, "min": 14.8, "max": 74.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
