...
# Generated by CadQuarry v0.3.0 — seed 1234004013 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 10.9, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    ...
    "boss_bore_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 5.8, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
