...
# Generated by CadQuarry v0.4.0 — seed 1234004346 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 38.1, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 96.5, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
