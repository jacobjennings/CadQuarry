...
# Generated by CadQuarry v0.1.0 — seed 1234003984 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 70.64, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 81.0, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
