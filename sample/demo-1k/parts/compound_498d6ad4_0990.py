...
# Generated by CadQuarry v0.6.0 — seed 1234004692 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 22.3, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 20.5, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 20.0, "min": 8.0, "max": 32.0, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 17.9, "min": 7.2, "max": 28.6, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 3.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 3.9, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
