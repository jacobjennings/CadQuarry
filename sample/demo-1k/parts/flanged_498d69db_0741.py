...
# Generated by CadQuarry v0.4.0 — seed 1234004443 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 27.8, "min": 8.3, "max": 69.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 16.2, "min": 2.0, "max": 24.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 60.4, "min": 45.5, "max": 105.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 6.0, "min": 1.8, "max": 11.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
