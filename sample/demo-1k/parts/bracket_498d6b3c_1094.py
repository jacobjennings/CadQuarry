...
# Generated by CadQuarry v0.3.0 — seed 1234004796 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 17.88, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 4.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "top_len": {"type": 'float', "default": 49.9, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    "hole_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 7.2, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
