...
# Generated by CadQuarry v0.4.0 — seed 1234003857 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 73.41, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 7.7, "min": 2.0, "max": 10.7, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
