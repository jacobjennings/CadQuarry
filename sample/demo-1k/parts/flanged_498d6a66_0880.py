...
# Generated by CadQuarry v0.6.0 — seed 1234004582 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 10.7, "min": 2.0, "max": 14.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 47.0, "min": 26.0, "max": 60.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 2.7, "min": 0.8, "max": 11.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 8.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 14.1, "min": 9.4, "max": 21.2, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
