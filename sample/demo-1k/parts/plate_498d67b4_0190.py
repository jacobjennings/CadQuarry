...
# Generated by CadQuarry v0.1.0 — seed 1234003892 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 50.0, "min": 25.0, "max": 76.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 21.6, "min": 10.8, "max": 30.7, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 1.9, "min": 0.8, "max": 5.1, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.06618516567327276)
    result = (
        result.faces('>Z').workplane()
