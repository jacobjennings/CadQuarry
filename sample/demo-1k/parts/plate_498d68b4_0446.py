...
# Generated by CadQuarry v0.3.0 — seed 1234004148 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 80.79, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 2.4, "min": 2.0, "max": 2.9, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
