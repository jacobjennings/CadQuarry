...
# Generated by CadQuarry v0.4.0 — seed 1234003900 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 56.9, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 12.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.05360351903994335)
    return result
