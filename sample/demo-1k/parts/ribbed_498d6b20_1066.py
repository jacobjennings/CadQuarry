...
# Generated by CadQuarry v0.1.0 — seed 1234004768 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 56.68, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 37.9, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
