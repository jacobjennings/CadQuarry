...
# Generated by CadQuarry v0.1.0 — seed 1234004275 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 67.5, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 91.3, "min": 36.5, "max": 182.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
