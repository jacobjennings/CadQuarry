...
# Generated by CadQuarry v0.6.0 — seed 1234004218 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 49.3, "min": 14.8, "max": 123.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 26.4, "min": 2.0, "max": 59.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 191.0, "min": 110.5, "max": 255.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 10.4, "min": 3.1, "max": 19.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
