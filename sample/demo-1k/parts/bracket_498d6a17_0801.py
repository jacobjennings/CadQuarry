...
# Generated by CadQuarry v0.3.0 — seed 1234004503 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 28.58, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.5, "min": 4.0, "max": 7.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
