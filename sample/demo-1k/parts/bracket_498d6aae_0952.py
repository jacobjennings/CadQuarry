...
# Generated by CadQuarry v0.1.0 — seed 1234004654 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 21.14, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 5.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 8.5, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "n_holes": {"type": 'int', "default": 1, "min": 1, "max": 3, "step": 1, "group": 'Holes', "label": 'Holes per leg'},
    "gusset_t": {"type": 'float', "default": 6.5, "min": 2.5, "max": 10.6, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
