...
# Generated by CadQuarry v0.4.0 — seed 1234004629 — CC0-1.0
...
PARAMS = {
    ...
    "col_d": {"type": 'float', "default": 21.9, "min": 10.9, "max": 34.6, "step": 1.0, "group": 'Column', "label": 'Column diameter (mm)'},
    "col_h": {"type": 'float', "default": 29.0, "min": 8.7, "max": 72.5, "step": 1.0, "group": 'Column', "label": 'Column height (mm)'},
    "col_bore": {"type": 'float', "default": 10.6, "min": 2.0, "max": 15.8, "step": 0.5, "group": 'Column', "label": 'Column bore diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["base_r"], p["base_r"]) * 0.07642505791606392)
    return result
