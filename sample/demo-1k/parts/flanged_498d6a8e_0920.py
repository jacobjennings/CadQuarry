...
# Generated by CadQuarry v0.4.0 — seed 1234004622 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 23.07, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 12.7, "min": 3.8, "max": 31.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 9.3, "min": 2.0, "max": 16.1, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 53.5, "min": 30.0, "max": 69.2, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.7, "min": 1.1, "max": 5.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
