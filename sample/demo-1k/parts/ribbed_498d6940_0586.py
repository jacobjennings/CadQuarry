...
# Generated by CadQuarry v0.6.0 — seed 1234004288 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 50.5, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 11.4, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
