...
# Generated by CadQuarry v0.4.0 — seed 1234004494 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 39.4, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 16.7, "min": 6.7, "max": 33.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
