...
# Generated by CadQuarry v0.3.0 — seed 1234004058 — CC0-1.0
...
PARAMS = {
    ...
    "plate_d": {"type": 'float', "default": 89.8, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 34.5, "min": 23.0, "max": 51.8, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
