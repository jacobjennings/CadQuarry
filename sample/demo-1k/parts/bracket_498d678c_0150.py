...
# Generated by CadQuarry v0.6.0 — seed 1234003852 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 53.2, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 4.3, "min": 2.5, "max": 15.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
