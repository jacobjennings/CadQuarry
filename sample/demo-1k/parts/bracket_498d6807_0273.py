...
# Generated by CadQuarry v0.1.0 — seed 1234003975 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 49.0, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 30.09, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 5.0, "min": 3.0, "max": 15.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
