...
# Generated by CadQuarry v0.1.0 — seed 1234004467 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 25.2, "min": 12.6, "max": 40.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 8.5, "min": 4.2, "max": 16.2, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 40.4, "min": 16.2, "max": 73.5, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
