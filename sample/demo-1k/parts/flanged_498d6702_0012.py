...
# Generated by CadQuarry v0.4.0 — seed 1234003714 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 59.2, "min": 17.8, "max": 148.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 25.2, "min": 2.0, "max": 56.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 171.7, "min": 104.0, "max": 240.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 8.9, "min": 2.7, "max": 23.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 51.5, "min": 34.3, "max": 77.3, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
