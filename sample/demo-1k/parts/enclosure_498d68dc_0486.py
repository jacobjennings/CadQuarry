...
# Generated by CadQuarry v0.3.0 — seed 1234004188 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 86.6, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 102.7, "min": 41.1, "max": 205.4, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
