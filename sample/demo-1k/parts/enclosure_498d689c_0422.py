...
# Generated by CadQuarry v0.1.0 — seed 1234004124 — CC0-1.0
...
PARAMS = {
    ...
    "enc_h": {"type": 'float', "default": 96.0, "min": 38.4, "max": 192.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
    "wall_t": {"type": 'float', "default": 2.9, "min": 2.0, "max": 6.0, "step": 0.5, "group": 'Body', "label": 'Wall thickness (mm)'},
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 11.1, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.07515823811514138)
    return result
