...
# Generated by CadQuarry v0.3.0 — seed 1234004168 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 108.54, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    ...
    "cb_d": {"type": 'float', "default": 8.6, "min": 6.4, "max": 12.9, "step": 0.5, "group": 'Holes', "label": 'Counterbore diameter (mm)'},
    "cb_depth": {"type": 'float', "default": 3.4, "min": 1.7, "max": 6.8, "step": 0.5, "group": 'Holes', "label": 'Counterbore depth (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.1157345461456788)
    return result
