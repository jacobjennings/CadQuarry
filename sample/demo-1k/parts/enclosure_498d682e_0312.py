...
# Generated by CadQuarry v0.6.0 — seed 1234004014 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 38.46, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 20.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 15.7, "min": 6.3, "max": 31.4, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
