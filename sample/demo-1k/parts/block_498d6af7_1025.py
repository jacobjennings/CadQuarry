...
# Generated by CadQuarry v0.4.0 — seed 1234004727 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 8.3, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 26.3, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    ...
    "boss_h": {"type": 'float', "default": 9.7, "min": 3.9, "max": 24.2, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 6.6, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
