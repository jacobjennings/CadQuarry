...
# Generated by CadQuarry v0.3.0 — seed 1234004431 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 75.01, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 246.5, "min": 74.0, "max": 320.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
