...
# Generated by CadQuarry v0.1.0 — seed 1234004033 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 9.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.08222298655071138)
    return result
