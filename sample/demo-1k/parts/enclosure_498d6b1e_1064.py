...
# Generated by CadQuarry v0.4.0 — seed 1234004766 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 44.5, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 61.9, "min": 24.8, "max": 123.8, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
