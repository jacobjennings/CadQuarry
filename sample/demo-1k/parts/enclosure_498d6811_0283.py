...
# Generated by CadQuarry v0.4.0 — seed 1234003985 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 70.98, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 33.9, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 36.3, "min": 14.5, "max": 72.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
