...
# Generated by CadQuarry v0.3.0 — seed 1234004798 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 93.9, "min": 28.2, "max": 281.7, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "flange_d": {"type": 'float', "default": 46.4, "min": 36.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 18.8, "min": 5.6, "max": 47.0, "step": 0.5, "group": 'Body', "label": 'Flange height (mm)'},
