...
# Generated by CadQuarry v0.3.0 — seed 1234004194 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 95.12, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 10.5, "min": 2.0, "max": 12.4, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
