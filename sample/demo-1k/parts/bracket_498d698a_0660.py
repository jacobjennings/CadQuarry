...
# Generated by CadQuarry v0.1.0 — seed 1234004362 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 39.67, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.5, "min": 4.0, "max": 19.8, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
