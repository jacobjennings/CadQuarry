...
# Generated by CadQuarry v0.4.0 — seed 1234004091 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 5.2, "min": 2.0, "max": 6.3, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.06331569157075662)
    return result
