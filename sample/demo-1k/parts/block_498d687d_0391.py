...
# Generated by CadQuarry v0.1.0 — seed 1234004093 — CC0-1.0
...
PARAMS = {
    ...
    "boss_h": {"type": 'float', "default": 11.4, "min": 4.6, "max": 28.5, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.05994492188397271)
    return result
