...
# Generated by CadQuarry v0.1.0 — seed 1234003737 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 27.7, "min": 13.8, "max": 44.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 10.8, "min": 5.4, "max": 18.8, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 30.8, "min": 12.3, "max": 64.1, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
