...
# Generated by CadQuarry v0.6.0 — seed 1234003750 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 106.2, "min": 31.9, "max": 265.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 36.9, "min": 2.0, "max": 59.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 157.1, "min": 110.5, "max": 255.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 14.5, "min": 4.3, "max": 42.5, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 47.1, "min": 31.4, "max": 70.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
