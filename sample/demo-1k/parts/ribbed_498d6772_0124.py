...
# Generated by CadQuarry v0.6.0 — seed 1234003826 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 47.2, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 8.8, "min": 3.5, "max": 17.6, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
