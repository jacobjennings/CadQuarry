...
# Generated by CadQuarry v0.3.0 — seed 1234004561 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 68.28, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 55.5, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 4.9, "min": 2.5, "max": 15.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
