...
# Generated by CadQuarry v0.5.0 — seed 1234003908 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 41.6, "min": 12.5, "max": 104.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 12.6, "min": 2.0, "max": 21.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 55.6, "min": 39.0, "max": 90.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.8, "min": 1.4, "max": 16.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
