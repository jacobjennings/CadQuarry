...
# Generated by CadQuarry v0.1.0 — seed 1234003772 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 51.4, "min": 15.4, "max": 128.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 20.7, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 87.0, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.4, "min": 1.3, "max": 20.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
