...
# Generated by CadQuarry v0.1.0 — seed 1234003927 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 45.3, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 97.1, "min": 38.8, "max": 194.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.09766760640932609)
    return result
