...
# Generated by CadQuarry v0.6.0 — seed 1234004054 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 61.2, "min": 24.5, "max": 122.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
