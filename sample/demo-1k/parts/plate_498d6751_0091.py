...
# Generated by CadQuarry v0.3.0 — seed 1234003793 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 13.0, "step": 0.5, "group": 'Holes', "label": 'Slot width (mm)'},
    "hole_slot_len": {"type": 'float', "default": 8.7, "min": 6.4, "max": 21.4, "step": 0.5, "group": 'Holes', "label": 'Slot length (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.11539795347921863)
    return result
