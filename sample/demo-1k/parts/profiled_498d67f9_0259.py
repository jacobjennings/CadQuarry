...
# Generated by CadQuarry v0.1.0 — seed 1234003961 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "circ_r": {"type": 'float', "default": 18.0, "min": 9.0, "max": 36.0, "step": 1.0, "group": 'Profile', "label": 'Circumscribed radius (mm)'},
