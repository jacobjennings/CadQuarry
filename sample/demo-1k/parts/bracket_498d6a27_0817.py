...
# Generated by CadQuarry v0.3.0 — seed 1234004519 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 78.2, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 9.7, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
