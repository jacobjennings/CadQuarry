...
# Generated by CadQuarry v0.3.0 — seed 1234004682 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 69.6, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 75.0, "min": 30.0, "max": 150.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
