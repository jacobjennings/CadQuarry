...
# Generated by CadQuarry v0.6.0 — seed 1234004088 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 42.1, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 27.9, "min": 11.2, "max": 44.6, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 24.0, "min": 9.6, "max": 38.4, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 10.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 5.3, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
    "block_hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 7.9, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
