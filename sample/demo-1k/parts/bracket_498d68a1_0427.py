...
# Generated by CadQuarry v0.3.0 — seed 1234004129 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 52.14, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 40.6, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 9.1, "min": 4.0, "max": 10.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
