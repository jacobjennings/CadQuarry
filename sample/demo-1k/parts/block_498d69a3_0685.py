...
# Generated by CadQuarry v0.1.0 — seed 1234004387 — CC0-1.0
...
PARAMS = {
    ...
    "boss_h": {"type": 'float', "default": 9.6, "min": 3.8, "max": 24.0, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 7.5, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.054292573880481185)
    return result
