...
# Generated by CadQuarry v0.6.0 — seed 1234004387 — CC0-1.0
...
PARAMS = {
    ...
    "side_tube_d": {"type": 'float', "default": 18.6, "min": 7.4, "max": 22.4, "step": 1.0, "group": 'Side Tube', "label": 'Side tube diameter (mm)'},
    "side_tube_len": {"type": 'float', "default": 19.4, "min": 5.8, "max": 55.8, "step": 1.0, "group": 'Side Tube', "label": 'Side tube length (mm)'},
    "side_bore_d": {"type": 'float', "default": 11.2, "min": 2.0, "max": 14.0, "step": 0.5, "group": 'Side Tube', "label": 'Side bore diameter (mm)'},
}
