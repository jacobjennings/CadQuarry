...
# Generated by CadQuarry v0.1.0 — seed 1234003878 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 102.9, "min": 30.9, "max": 257.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 30.3, "min": 2.0, "max": 49.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 148.7, "min": 91.0, "max": 210.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 10.8, "min": 3.2, "max": 41.2, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 5.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 44.6, "min": 29.7, "max": 66.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
