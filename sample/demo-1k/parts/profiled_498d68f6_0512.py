...
# Generated by CadQuarry v0.3.0 — seed 1234004214 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "circ_r": {"type": 'float', "default": 19.57, "min": 9.8, "max": 39.1, "step": 1.0, "group": 'Profile', "label": 'Circumscribed radius (mm)'},
