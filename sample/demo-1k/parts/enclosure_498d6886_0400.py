...
# Generated by CadQuarry v0.6.0 — seed 1234004102 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 25.0, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 25.1, "min": 10.0, "max": 50.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
