...
# Generated by CadQuarry v0.6.0 — seed 1234004328 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 75.44, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 91.8, "min": 27.5, "max": 229.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 32.9, "min": 2.0, "max": 52.8, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 161.2, "min": 98.1, "max": 226.3, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 12.5, "min": 3.8, "max": 36.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
