...
# Generated by CadQuarry v0.5.0 — seed 1234004030 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 27.7, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.6, "min": 3.0, "max": 18.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
