...
# Generated by CadQuarry v0.1.0 — seed 1234004355 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "circ_r": {"type": 'float', "default": 22.83, "min": 11.4, "max": 45.7, "step": 1.0, "group": 'Profile', "label": 'Circumscribed radius (mm)'},
