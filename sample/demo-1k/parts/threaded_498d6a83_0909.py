...
# Generated by CadQuarry v0.6.0 — seed 1234004611 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 38.2, "min": 15.3, "max": 76.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
