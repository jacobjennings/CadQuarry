...
# Generated by CadQuarry v0.1.0 — seed 1234004506 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 127.6, "min": 38.3, "max": 319.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 31.3, "min": 2.0, "max": 63.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 175.9, "min": 117.0, "max": 270.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 13.9, "min": 4.2, "max": 51.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 5.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 52.8, "min": 35.2, "max": 79.2, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
