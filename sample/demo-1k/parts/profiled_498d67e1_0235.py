...
# Generated by CadQuarry v0.6.0 — seed 1234003937 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 47.44, "min": 23.7, "max": 94.9, "step": 1.0, "group": 'Profile', "label": 'Outer diameter (mm)'},
