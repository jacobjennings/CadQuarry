...
# Generated by CadQuarry v0.6.0 — seed 1234004077 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 91.4, "min": 27.4, "max": 228.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 29.0, "min": 2.0, "max": 45.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 131.2, "min": 84.5, "max": 195.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 5.7, "min": 1.7, "max": 36.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
