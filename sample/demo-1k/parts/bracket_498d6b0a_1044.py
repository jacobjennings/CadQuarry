...
# Generated by CadQuarry v0.3.0 — seed 1234004746 — CC0-1.0
...
PARAMS = {
    ...
    "top_len": {"type": 'float', "default": 59.4, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.6, "min": 2.5, "max": 10.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
