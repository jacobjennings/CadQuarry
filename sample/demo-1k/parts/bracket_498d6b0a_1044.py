...
# Generated by CadQuarry v0.1.0 — seed 1234004746 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 85.66, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 7.4, "min": 3.0, "max": 18.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
