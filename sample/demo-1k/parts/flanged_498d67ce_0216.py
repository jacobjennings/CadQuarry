...
# Generated by CadQuarry v0.5.0 — seed 1234003918 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 49.56, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 69.5, "min": 20.8, "max": 173.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 19.6, "min": 2.0, "max": 34.7, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 97.4, "min": 64.4, "max": 148.7, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 8.9, "min": 2.7, "max": 27.8, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
