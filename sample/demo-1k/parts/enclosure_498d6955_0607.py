...
# Generated by CadQuarry v0.1.0 — seed 1234004309 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 77.45, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 33.9, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 42.9, "min": 17.2, "max": 85.8, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
