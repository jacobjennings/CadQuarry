...
# Generated by CadQuarry v0.1.0 — seed 1234004222 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 50.9, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.7, "min": 4.0, "max": 10.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
