...
# Generated by CadQuarry v0.3.0 — seed 1234004222 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 39.74, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 27.5, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 21.98, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 5.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "hole_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 8.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "n_holes": {"type": 'int', "default": 1, "min": 1, "max": 3, "step": 1, "group": 'Holes', "label": 'Holes per leg'},
    "gusset_t": {"type": 'float', "default": 5.5, "min": 2.5, "max": 11.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
