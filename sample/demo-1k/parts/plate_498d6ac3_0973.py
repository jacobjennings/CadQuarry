...
# Generated by CadQuarry v0.1.0 — seed 1234004675 — CC0-1.0
...
def build(p):
    ...
    result = (
        ...
        .rarray(34.3, 30.1, p["hole_nx"], p["hole_ny"])
        .hole(p["hole_d"])
    )
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.049265465830297346)
    return result
