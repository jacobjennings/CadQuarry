...
# Generated by CadQuarry v0.6.0 — seed 1234004623 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 17.3, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 25.8, "min": 10.3, "max": 51.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
