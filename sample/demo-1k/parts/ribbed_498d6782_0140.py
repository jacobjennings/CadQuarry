...
# Generated by CadQuarry v0.1.0 — seed 1234003842 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 31.9, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 17.2, "min": 6.9, "max": 34.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
