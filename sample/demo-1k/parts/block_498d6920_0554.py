...
# Generated by CadQuarry v0.4.0 — seed 1234004256 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 77.82, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    "block_d": {"type": 'float', "default": 46.4, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    ...
    "pocket_w": {"type": 'float', "default": 34.8, "min": 17.4, "max": 62.3, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 19.2, "min": 9.6, "max": 37.1, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 31.6, "min": 12.6, "max": 72.2, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
