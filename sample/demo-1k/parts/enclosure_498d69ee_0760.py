...
# Generated by CadQuarry v0.4.0 — seed 1234004462 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 95.5, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 60.6, "min": 24.2, "max": 121.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
