...
# Generated by CadQuarry v0.3.0 — seed 1234004492 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 23.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 10.7, "min": 4.3, "max": 21.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
