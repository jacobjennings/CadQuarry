...
# Generated by CadQuarry v0.1.0 — seed 1234004576 — CC0-1.0
...
PARAMS = {
    ...
    "boss_d": {"type": 'float', "default": 10.9, "min": 5.5, "max": 21.8, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 8.7, "min": 3.5, "max": 21.8, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 7.6, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
