...
# Generated by CadQuarry v0.6.0 — seed 1234004022 — CC0-1.0
...
PARAMS = {
    ...
    "top_len": {"type": 'float', "default": 80.3, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 3.6, "min": 1.5, "max": 7.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
