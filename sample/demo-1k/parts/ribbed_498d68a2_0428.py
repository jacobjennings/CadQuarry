...
# Generated by CadQuarry v0.1.0 — seed 1234004130 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 55.84, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 5.8, "min": 2.3, "max": 11.6, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
    "rib_t": {"type": 'float', "default": 2.3, "min": 1.0, "max": 5.8, "step": 0.5, "group": 'Ribs', "label": 'Rib thickness (mm)'},
    "hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 12.5, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
