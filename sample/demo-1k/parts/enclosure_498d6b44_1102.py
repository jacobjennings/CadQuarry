...
# Generated by CadQuarry v0.3.0 — seed 1234004804 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 38.4, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 27.6, "min": 11.0, "max": 55.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
