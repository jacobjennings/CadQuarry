...
# Generated by CadQuarry v0.6.0 — seed 1234004233 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 27.9, "min": 11.2, "max": 55.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
