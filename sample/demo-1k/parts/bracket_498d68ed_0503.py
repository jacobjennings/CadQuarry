...
# Generated by CadQuarry v0.3.0 — seed 1234004205 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 78.4, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 50.8, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
