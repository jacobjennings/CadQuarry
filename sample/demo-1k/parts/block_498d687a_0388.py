...
# Generated by CadQuarry v0.3.0 — seed 1234004090 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 37.6, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 8.0, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
