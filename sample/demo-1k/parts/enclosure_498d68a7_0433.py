...
# Generated by CadQuarry v0.3.0 — seed 1234004135 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 90.81, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 39.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 72.3, "min": 28.9, "max": 144.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
