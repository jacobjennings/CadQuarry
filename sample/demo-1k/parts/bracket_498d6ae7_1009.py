...
# Generated by CadQuarry v0.1.0 — seed 1234004711 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 33.97, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 4.5, "min": 1.5, "max": 9.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
