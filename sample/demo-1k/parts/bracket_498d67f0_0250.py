...
# Generated by CadQuarry v0.1.0 — seed 1234003952 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 30.65, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.7, "min": 3.0, "max": 15.3, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
