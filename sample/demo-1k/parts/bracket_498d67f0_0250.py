...
# Generated by CadQuarry v0.3.0 — seed 1234003952 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 49.73, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 11.6, "min": 4.0, "max": 24.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
