...
# Generated by CadQuarry v0.1.0 — seed 1234004432 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 31.8, "min": 15.9, "max": 42.3, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 21.5, "min": 10.8, "max": 32.2, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 52.0, "min": 20.8, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
