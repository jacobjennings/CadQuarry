...
# Generated by CadQuarry v0.6.0 — seed 1234004621 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 47.0, "min": 18.8, "max": 94.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
