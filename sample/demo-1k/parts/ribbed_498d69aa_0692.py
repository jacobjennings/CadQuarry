...
# Generated by CadQuarry v0.3.0 — seed 1234004394 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 42.0, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 5.6, "min": 2.2, "max": 11.2, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
