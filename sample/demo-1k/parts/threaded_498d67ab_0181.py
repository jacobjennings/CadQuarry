...
# Generated by CadQuarry v0.6.0 — seed 1234003883 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 43.2, "min": 17.3, "max": 86.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
