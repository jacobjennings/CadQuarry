...
# Generated by CadQuarry v0.6.0 — seed 1234003930 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 27.8, "min": 11.1, "max": 55.6, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
