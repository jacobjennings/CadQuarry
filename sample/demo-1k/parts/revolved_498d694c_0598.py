...
# Generated by CadQuarry v0.1.0 — seed 1234004300 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 117.5, "min": 35.2, "max": 320.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "flange_d": {"type": 'float', "default": 83.3, "min": 54.0, "max": 135.0, "step": 1.0, "group": 'Body', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 27.0, "min": 8.1, "max": 58.8, "step": 0.5, "group": 'Body', "label": 'Flange height (mm)'},
