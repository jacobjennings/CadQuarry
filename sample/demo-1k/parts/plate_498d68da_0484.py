...
# Generated by CadQuarry v0.1.0 — seed 1234004186 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 43.4, "min": 21.7, "max": 72.6, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 27.6, "min": 13.8, "max": 45.7, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 5.8, "min": 2.3, "max": 8.5, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.11587441161401155)
    result = (
        result.faces('>Z').workplane()
