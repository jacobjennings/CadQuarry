...
# Generated by CadQuarry v0.6.0 — seed 1234003906 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 85.43, "min": 30.0, "max": 160.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 74.1, "min": 25.0, "max": 160.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "col_r": {"type": 'float', "default": 9.5, "min": 4.8, "max": 18.5, "step": 1.0, "group": 'Column', "label": 'Column circumradius (mm)'},
    "col_h": {"type": 'float', "default": 74.6, "min": 22.4, "max": 223.8, "step": 1.0, "group": 'Column', "label": 'Column height (mm)'},
