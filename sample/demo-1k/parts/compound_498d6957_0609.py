...
# Generated by CadQuarry v0.6.0 — seed 1234004311 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 65.5, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 54.1, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 62.7, "min": 25.1, "max": 100.3, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 36.0, "min": 14.4, "max": 57.6, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 10.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 7.9, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
