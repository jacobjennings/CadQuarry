...
# Generated by CadQuarry v0.6.0 — seed 1234004056 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 58.1, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 65.8, "min": 10.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "tab_a": {"type": 'float', "default": 37.5, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Tab', "label": 'Tab width (mm)'},
    "tab_b": {"type": 'float', "default": 52.9, "min": 21.2, "max": 84.6, "step": 1.0, "group": 'Tab', "label": 'Tab height (mm)'},
    "tab_t": {"type": 'float', "default": 4.0, "min": 2.0, "max": 15.0, "step": 0.5, "group": 'Tab', "label": 'Tab thickness (mm)'},
    "tab_hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 8.2, "step": 0.1, "group": 'Tab', "label": 'Tab hole diameter (mm)'},
}
