...
# Generated by CadQuarry v0.6.0 — seed 1234004531 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 243.3, "min": 73.0, "max": 320.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 22.3, "min": 2.0, "max": 49.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
