...
# Generated by CadQuarry v0.3.0 — seed 1234004679 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 32.0, "min": 2.0, "max": 45.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 139.8, "min": 84.5, "max": 195.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 6.9, "min": 2.1, "max": 32.4, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
