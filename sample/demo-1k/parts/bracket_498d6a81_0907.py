...
# Generated by CadQuarry v0.1.0 — seed 1234004609 — CC0-1.0
...
PARAMS = {
    ...
    "gusset_t": {"type": 'float', "default": 11.3, "min": 4.0, "max": 12.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
