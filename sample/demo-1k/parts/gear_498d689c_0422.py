...
# Generated by CadQuarry v0.5.0 — seed 1234004124 — CC0-1.0
...
PARAMS = {
    ...
    "root_fillet": {"type": 'float', "default": 0.22, "min": 0.0, "max": 0.75, "step": 0.05, "group": 'Gear', "label": 'Root fillet (mm)'},
    "bore_d": {"type": 'float', "default": 3.8, "min": 2.0, "max": 8.5, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
