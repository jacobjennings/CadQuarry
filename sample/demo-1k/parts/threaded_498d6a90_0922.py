...
# Generated by CadQuarry v0.6.0 — seed 1234004624 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 46.9, "min": 18.8, "max": 93.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
