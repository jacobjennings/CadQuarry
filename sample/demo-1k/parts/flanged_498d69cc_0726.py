...
# Generated by CadQuarry v0.1.0 — seed 1234004428 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 40.0, "min": 12.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 24.6, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 89.2, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 7.0, "min": 2.1, "max": 16.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
