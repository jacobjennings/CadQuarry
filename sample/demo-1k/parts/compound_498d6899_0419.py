...
# Generated by CadQuarry v0.4.0 — seed 1234004121 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 65.3, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body depth (mm)'},
    "block_h": {"type": 'float', "default": 48.8, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body height (mm)'},
    "port_sides": {"type": 'int', "default": 6, "min": 3, "max": 8, "step": 1, "group": 'Ports', "label": 'Ports sides'},
    "port_r": {"type": 'float', "default": 5.2, "min": 2.6, "max": 11.0, "step": 1.0, "group": 'Ports', "label": 'Ports circumradius (mm)'},
    "port_len": {"type": 'float', "default": 6.2, "min": 2.3, "max": 27.0, "step": 1.0, "group": 'Ports', "label": 'Port boss length (mm)'},
    "port_bore": {"type": 'float', "default": 4.5, "min": 2.0, "max": 6.5, "step": 0.5, "group": 'Ports', "label": 'Port bore diameter (mm)'},
