...
# Generated by CadQuarry v0.1.0 — seed 1234004473 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 9.6, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.10802399687084954)
    return result
