...
# Generated by CadQuarry v0.3.0 — seed 1234004163 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 55.06, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 46.8, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 22.95, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 5.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "top_len": {"type": 'float', "default": 42.2, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 9.2, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "n_holes": {"type": 'int', "default": 1, "min": 1, "max": 3, "step": 1, "group": 'Holes', "label": 'Holes per flange'},
    "gusset_t": {"type": 'float', "default": 4.7, "min": 2.5, "max": 11.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
