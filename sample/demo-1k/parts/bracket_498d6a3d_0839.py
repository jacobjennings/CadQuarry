...
# Generated by CadQuarry v0.1.0 — seed 1234004541 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 64.63, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 42.5, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 6.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
