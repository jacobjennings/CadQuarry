...
# Generated by CadQuarry v0.6.0 — seed 1234003747 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 61.5, "min": 24.6, "max": 123.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
