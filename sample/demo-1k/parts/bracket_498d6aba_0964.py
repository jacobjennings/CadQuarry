...
# Generated by CadQuarry v0.3.0 — seed 1234004666 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 17.04, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 9.5, "min": 4.0, "max": 8.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
