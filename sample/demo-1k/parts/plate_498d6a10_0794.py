...
# Generated by CadQuarry v0.3.0 — seed 1234004496 — CC0-1.0
...
PARAMS = {
    ...
    "bolt_r": {"type": 'float', "default": 31.5, "min": 21.0, "max": 47.2, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.04441410097855854)
    return result
