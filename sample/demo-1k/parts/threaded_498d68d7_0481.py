...
# Generated by CadQuarry v0.5.0 — seed 1234004183 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 25.3, "min": 10.1, "max": 50.6, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
