...
# Generated by CadQuarry v0.6.0 — seed 1234004183 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 25.5, "min": 10.2, "max": 51.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
