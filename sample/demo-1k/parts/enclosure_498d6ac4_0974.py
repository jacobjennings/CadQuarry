...
# Generated by CadQuarry v0.3.0 — seed 1234004676 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 31.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 18.1, "min": 7.2, "max": 36.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
    "wall_t": {"type": 'float', "default": 3.1, "min": 2.0, "max": 6.0, "step": 0.5, "group": 'Body', "label": 'Wall thickness (mm)'},
    "hole_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 7.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
