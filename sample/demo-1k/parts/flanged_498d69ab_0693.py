...
# Generated by CadQuarry v0.5.0 — seed 1234004395 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 81.7, "min": 24.5, "max": 204.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 32.4, "min": 2.0, "max": 52.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 134.0, "min": 97.5, "max": 225.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 10.6, "min": 3.2, "max": 32.7, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 40.2, "min": 26.8, "max": 60.3, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
