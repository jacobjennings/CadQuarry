...
# Generated by CadQuarry v0.3.0 — seed 1234004754 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 27.8, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 100.0, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 2.2, "min": 2.0, "max": 2.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "hole_nx": {"type": 'int', "default": 4, "min": 2, "max": 5, "step": 1, "group": 'Holes', "label": 'Holes per row'},
    "boss_d": {"type": 'float', "default": 22.5, "min": 11.2, "max": 45.0, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 10.0, "min": 4.0, "max": 25.0, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 5.3, "min": 2.0, "max": 15.7, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
