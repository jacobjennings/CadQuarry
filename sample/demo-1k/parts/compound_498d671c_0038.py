...
# Generated by CadQuarry v0.6.0 — seed 1234003740 — CC0-1.0
...
PARAMS = {
    ...
    "base_h": {"type": 'float', "default": 14.2, "min": 5.7, "max": 35.5, "step": 1.0, "group": 'Base', "label": 'Base height (mm)'},
    "col_d": {"type": 'float', "default": 22.1, "min": 11.1, "max": 27.7, "step": 1.0, "group": 'Column', "label": 'Column diameter (mm)'},
