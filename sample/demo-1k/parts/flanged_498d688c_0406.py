...
# Generated by CadQuarry v0.6.0 — seed 1234004108 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 68.1, "min": 20.4, "max": 170.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 23.7, "min": 2.0, "max": 49.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 163.1, "min": 91.0, "max": 210.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 9.3, "min": 2.8, "max": 27.2, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 48.9, "min": 32.6, "max": 73.4, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
