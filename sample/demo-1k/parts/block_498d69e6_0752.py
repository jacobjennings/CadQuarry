...
# Generated by CadQuarry v0.4.0 — seed 1234004454 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 39.33, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 11.8, "min": 7.9, "max": 17.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
