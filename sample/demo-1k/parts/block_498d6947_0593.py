...
# Generated by CadQuarry v0.4.0 — seed 1234004295 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 27.6, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 2.2, "min": 2.0, "max": 3.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.041507727822140725)
    return result
