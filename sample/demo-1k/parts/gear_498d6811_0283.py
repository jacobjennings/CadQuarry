...
# Generated by CadQuarry v0.6.0 — seed 1234003985 — CC0-1.0
...
PARAMS = {
    ...
    "gear_w": {"type": 'float', "default": 31.0, "min": 12.4, "max": 77.5, "step": 1.0, "group": 'Gear', "label": 'Face width (mm)'},
    "bore_d": {"type": 'float', "default": 15.4, "min": 2.0, "max": 40.5, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
