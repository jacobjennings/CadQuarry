...
# Generated by CadQuarry v0.4.0 — seed 1234004562 — CC0-1.0
...
PARAMS = {
    ...
    "boss_d": {"type": 'float', "default": 24.0, "min": 12.0, "max": 48.0, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 4.3, "min": 1.7, "max": 10.8, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 16.8, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
}
