...
# Generated by CadQuarry v0.5.0 — seed 1234004790 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 30.8, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 11.3, "min": 4.0, "max": 24.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
