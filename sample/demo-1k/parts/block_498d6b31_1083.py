...
# Generated by CadQuarry v0.4.0 — seed 1234004785 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 45.5, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 78.9, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.042273329591796006)
    return result
