...
# Generated by CadQuarry v0.3.0 — seed 1234004381 — CC0-1.0
...
PARAMS = {
    ...
    "slot_w": {"type": 'float', "default": 10.36, "min": 5.2, "max": 20.7, "step": 0.5, "group": 'Profile', "label": 'Slot width (mm)'},
    "length": {"type": 'float', "default": 276.5, "min": 83.0, "max": 829.5, "step": 5.0, "group": 'Body', "label": 'Length (mm)'},
}
