...
# Generated by CadQuarry v0.5.0 — seed 1234004760 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 78.48, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 53.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 12.1, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
