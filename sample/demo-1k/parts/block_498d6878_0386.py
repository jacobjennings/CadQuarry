...
# Generated by CadQuarry v0.1.0 — seed 1234004088 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 52.7, "min": 26.4, "max": 80.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 34.7, "min": 17.4, "max": 66.4, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 50.9, "min": 20.4, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
