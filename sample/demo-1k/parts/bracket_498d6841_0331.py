...
# Generated by CadQuarry v0.4.0 — seed 1234004033 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 67.82, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 78.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 9.0, "min": 4.0, "max": 24.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
