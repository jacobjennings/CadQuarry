...
# Generated by CadQuarry v0.3.0 — seed 1234003848 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 55.2, "min": 16.6, "max": 138.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 16.4, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 110.9, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 6.6, "min": 2.0, "max": 22.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 33.3, "min": 22.2, "max": 49.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
