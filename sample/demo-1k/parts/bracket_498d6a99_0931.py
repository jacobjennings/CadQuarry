...
# Generated by CadQuarry v0.3.0 — seed 1234004633 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 58.2, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 22.0, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 5.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "top_len": {"type": 'float', "default": 46.7, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 8.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "n_holes": {"type": 'int', "default": 1, "min": 1, "max": 3, "step": 1, "group": 'Holes', "label": 'Holes per flange'},
    "gusset_t": {"type": 'float', "default": 6.1, "min": 2.5, "max": 11.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
