...
# Generated by CadQuarry v0.4.0 — seed 1234003743 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 34.16, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 24.9, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 18.9, "min": 7.6, "max": 37.8, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
