...
# Generated by CadQuarry v0.3.0 — seed 1234003863 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 12.4, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.06900783078805453)
    return result
