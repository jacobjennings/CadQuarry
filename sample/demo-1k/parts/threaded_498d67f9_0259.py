...
# Generated by CadQuarry v0.6.0 — seed 1234003961 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 55.1, "min": 22.0, "max": 110.2, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
