...
# Generated by CadQuarry v0.1.0 — seed 1234004735 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 38.2, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 40.7, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
