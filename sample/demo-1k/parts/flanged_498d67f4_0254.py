...
# Generated by CadQuarry v0.3.0 — seed 1234003956 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 31.7, "min": 2.0, "max": 56.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 157.6, "min": 104.0, "max": 240.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 7.8, "min": 2.3, "max": 20.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 47.3, "min": 31.5, "max": 70.9, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
