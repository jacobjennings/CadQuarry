...
# Generated by CadQuarry v0.1.0 — seed 1234004405 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 27.64, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 21.0, "min": 6.3, "max": 52.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 14.2, "min": 2.0, "max": 19.3, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 52.3, "min": 35.9, "max": 82.9, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 4.7, "min": 1.4, "max": 8.4, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
