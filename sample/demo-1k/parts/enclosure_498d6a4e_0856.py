...
# Generated by CadQuarry v0.6.0 — seed 1234004558 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 33.7, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 48.3, "min": 19.3, "max": 96.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
