...
# Generated by CadQuarry v0.6.0 — seed 1234004095 — CC0-1.0
...
PARAMS = {
    ...
    "base_h": {"type": 'float', "default": 25.2, "min": 10.1, "max": 63.0, "step": 1.0, "group": 'Base', "label": 'Base height (mm)'},
    "col_d": {"type": 'float', "default": 27.9, "min": 13.9, "max": 34.6, "step": 1.0, "group": 'Column', "label": 'Column diameter (mm)'},
    "col_h": {"type": 'float', "default": 38.9, "min": 11.7, "max": 97.2, "step": 1.0, "group": 'Column', "label": 'Column height (mm)'},
}
