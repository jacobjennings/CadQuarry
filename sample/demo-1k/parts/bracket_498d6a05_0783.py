...
# Generated by CadQuarry v0.1.0 — seed 1234004485 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 29.08, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 7.9, "min": 3.0, "max": 14.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
