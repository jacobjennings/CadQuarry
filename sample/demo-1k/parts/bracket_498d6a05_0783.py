...
# Generated by CadQuarry v0.3.0 — seed 1234004485 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 59.39, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 5.1, "min": 3.0, "max": 18.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
