...
# Generated by CadQuarry v0.1.0 — seed 1234004139 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 6.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
...
def build(p):
    ...
    result = (
        ...
        .rarray(77.8, 40.2, p["hole_nx"], p["hole_ny"])
        .hole(p["hole_d"])
    )
    return result
