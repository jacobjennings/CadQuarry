...
# Generated by CadQuarry v0.4.0 — seed 1234004452 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 21.5, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    "block_h": {"type": 'float', "default": 54.0, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "bolt_d": {"type": 'float', "default": 8.4, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 13.5, "min": 9.0, "max": 20.2, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
