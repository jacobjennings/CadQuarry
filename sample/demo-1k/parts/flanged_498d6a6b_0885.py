...
# Generated by CadQuarry v0.6.0 — seed 1234004587 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 43.74, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 62.7, "min": 18.8, "max": 156.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 22.0, "min": 2.0, "max": 30.6, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 80.2, "min": 56.9, "max": 131.2, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 7.5, "min": 2.2, "max": 25.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
