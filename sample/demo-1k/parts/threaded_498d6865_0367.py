...
# Generated by CadQuarry v0.6.0 — seed 1234004069 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 30.0, "min": 12.0, "max": 60.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
