...
# Generated by CadQuarry v0.1.0 — seed 1234004329 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 38.55, "min": 6.0, "max": 80.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 44.4, "min": 13.3, "max": 133.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 21.5, "min": 2.0, "max": 27.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
