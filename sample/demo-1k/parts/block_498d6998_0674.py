...
# Generated by CadQuarry v0.1.0 — seed 1234004376 — CC0-1.0
...
PARAMS = {
    ...
    "boss_d": {"type": 'float', "default": 22.0, "min": 11.0, "max": 44.0, "step": 1.0, "group": 'Boss', "label": 'Boss diameter (mm)'},
    "boss_h": {"type": 'float', "default": 6.4, "min": 2.6, "max": 16.0, "step": 1.0, "group": 'Boss', "label": 'Boss height (mm)'},
    "boss_bore_d": {"type": 'float', "default": 10.5, "min": 2.0, "max": 15.4, "step": 0.1, "group": 'Boss', "label": 'Bore diameter (mm)'},
...
def build(p):
    ...
    if p["filleted2"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.05010419732733877)
    return result
