...
# Generated by CadQuarry v0.6.0 — seed 1234004555 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 19.0, "min": 5.7, "max": 47.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 6.4, "min": 2.0, "max": 14.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 37.5, "min": 26.0, "max": 60.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 2.6, "min": 0.8, "max": 7.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
