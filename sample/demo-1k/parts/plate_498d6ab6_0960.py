...
# Generated by CadQuarry v0.6.0 — seed 1234004662 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 115.94, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 69.6, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "chamfer_d": {"type": 'float', "default": 3.0, "min": 1.8, "max": 3.0, "step": 0.5, "group": 'Body', "label": 'Chamfer distance (mm)'},
