...
# Generated by CadQuarry v0.6.0 — seed 1234003781 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 35.42, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 21.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 13.2, "min": 5.3, "max": 26.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
