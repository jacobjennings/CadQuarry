...
# Generated by CadQuarry v0.6.0 — seed 1234004454 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 42.9, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 45.6, "min": 13.7, "max": 114.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 13.2, "min": 2.0, "max": 30.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 78.0, "min": 55.8, "max": 128.7, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.8, "min": 1.1, "max": 18.2, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
