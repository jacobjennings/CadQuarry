...
# Generated by CadQuarry v0.4.0 — seed 1234003711 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 163.4, "min": 49.0, "max": 320.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 23.4, "min": 2.0, "max": 45.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
}
