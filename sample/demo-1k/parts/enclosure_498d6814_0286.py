...
# Generated by CadQuarry v0.1.0 — seed 1234003988 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 24.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["enc_w"], p["enc_d"]) * 0.09673396751601251)
    return result
