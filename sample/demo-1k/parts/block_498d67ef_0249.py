...
# Generated by CadQuarry v0.4.0 — seed 1234003951 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 74.45, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 5.2, "min": 2.0, "max": 11.5, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
