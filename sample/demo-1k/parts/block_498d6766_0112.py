...
# Generated by CadQuarry v0.5.0 — seed 1234003814 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 27.89, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 2.1, "min": 2.0, "max": 3.1, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
