...
# Generated by CadQuarry v0.1.0 — seed 1234004513 — CC0-1.0
...
PARAMS = {
    ...
    "plate_d": {"type": 'float', "default": 52.7, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    "thickness": {"type": 'float', "default": 12.0, "min": 2.0, "max": 12.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "hole_d": {"type": 'float', "default": 8.4, "min": 2.0, "max": 11.9, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
