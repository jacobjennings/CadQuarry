...
# Generated by CadQuarry v0.6.0 — seed 1234004210 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 104.53, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    "enc_d": {"type": 'float', "default": 47.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 43.1, "min": 17.2, "max": 86.2, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
