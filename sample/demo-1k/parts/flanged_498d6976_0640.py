...
# Generated by CadQuarry v0.3.0 — seed 1234004342 — CC0-1.0
...
PARAMS = {
    ...
    "inner_d": {"type": 'float', "default": 44.7, "min": 2.0, "max": 63.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 178.4, "min": 117.0, "max": 270.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 12.2, "min": 3.7, "max": 50.5, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 53.5, "min": 35.7, "max": 80.3, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
