...
# Generated by CadQuarry v0.3.0 — seed 1234004734 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 58.14, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 8.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "top_len": {"type": 'float', "default": 70.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.5, "min": 4.0, "max": 24.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
