...
# Generated by CadQuarry v0.4.0 — seed 1234004761 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "block_w": {"type": 'float', "default": 75.29, "min": 15.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block width (mm)'},
    "block_d": {"type": 'float', "default": 41.0, "min": 6.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Block depth (mm)'},
    ...
    "pocket_w": {"type": 'float', "default": 34.4, "min": 17.2, "max": 60.2, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 26.3, "min": 13.2, "max": 32.8, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 38.8, "min": 15.5, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
