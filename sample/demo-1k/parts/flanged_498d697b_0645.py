...
# Generated by CadQuarry v0.6.0 — seed 1234004347 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 70.3, "min": 21.1, "max": 175.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 19.7, "min": 2.0, "max": 38.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 102.4, "min": 71.5, "max": 165.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 9.4, "min": 2.8, "max": 28.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
