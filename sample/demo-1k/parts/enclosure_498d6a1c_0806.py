...
# Generated by CadQuarry v0.1.0 — seed 1234004508 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 23.3, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 34.5, "min": 13.8, "max": 69.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
