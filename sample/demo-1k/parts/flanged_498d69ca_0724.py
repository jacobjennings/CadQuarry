...
# Generated by CadQuarry v0.3.0 — seed 1234004426 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 80.93, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 92.3, "min": 27.7, "max": 230.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 40.3, "min": 2.0, "max": 56.7, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 146.4, "min": 105.2, "max": 242.8, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 9.1, "min": 2.7, "max": 36.9, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
