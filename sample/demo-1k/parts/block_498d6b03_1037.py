...
# Generated by CadQuarry v0.4.0 — seed 1234004739 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 8.4, "min": 2.0, "max": 9.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "pocket_w": {"type": 'float', "default": 37.3, "min": 18.6, "max": 48.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 28.3, "min": 14.2, "max": 34.7, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 19.2, "min": 7.7, "max": 49.4, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
