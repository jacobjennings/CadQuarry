...
# Generated by CadQuarry v0.1.0 — seed 1234003816 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 78.29, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 57.5, "min": 17.2, "max": 143.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 26.0, "min": 2.0, "max": 54.8, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 154.6, "min": 101.8, "max": 234.9, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 12.9, "min": 3.9, "max": 23.0, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
