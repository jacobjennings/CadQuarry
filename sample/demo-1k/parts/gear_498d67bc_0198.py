...
# Generated by CadQuarry v0.6.0 — seed 1234003900 — CC0-1.0
...
PARAMS = {
    ...
    "gear_w": {"type": 'float', "default": 19.2, "min": 7.7, "max": 48.0, "step": 1.0, "group": 'Gear', "label": 'Face width (mm)'},
    "bore_d": {"type": 'float', "default": 12.8, "min": 2.0, "max": 34.8, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
