...
# Generated by CadQuarry v0.1.0 — seed 1234003710 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 30.19, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 6.4, "min": 3.0, "max": 7.1, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
    "n_holes": {"type": 'int', "default": 1, "min": 1, "max": 3, "step": 1, "group": 'Holes', "label": 'Holes per leg'},
    "gusset_t": {"type": 'float', "default": 5.9, "min": 3.0, "max": 8.9, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
