...
# Generated by CadQuarry v0.4.0 — seed 1234004706 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 48.4, "min": 14.5, "max": 121.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 18.4, "min": 2.0, "max": 42.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 105.7, "min": 78.0, "max": 180.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 6.4, "min": 1.9, "max": 19.4, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
