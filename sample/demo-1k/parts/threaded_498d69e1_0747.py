...
# Generated by CadQuarry v0.5.0 — seed 1234004449 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 53.5, "min": 21.4, "max": 107.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
