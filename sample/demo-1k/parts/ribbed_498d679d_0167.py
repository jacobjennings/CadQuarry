...
# Generated by CadQuarry v0.3.0 — seed 1234003869 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 35.4, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    "base_d": {"type": 'float', "default": 22.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 7.7, "min": 3.1, "max": 15.4, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
    "rib_t": {"type": 'float', "default": 4.1, "min": 1.0, "max": 10.2, "step": 0.5, "group": 'Ribs', "label": 'Rib thickness (mm)'},
}
