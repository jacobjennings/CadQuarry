...
# Generated by CadQuarry v0.6.0 — seed 1234004324 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 27.6, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 36.5, "min": 14.6, "max": 73.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
