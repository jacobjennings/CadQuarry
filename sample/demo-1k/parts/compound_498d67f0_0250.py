...
# Generated by CadQuarry v0.5.0 — seed 1234003952 — CC0-1.0
...
PARAMS = {
    ...
    "block_d": {"type": 'float', "default": 42.6, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body depth (mm)'},
    "block_h": {"type": 'float', "default": 48.7, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body height (mm)'},
    "port_sides": {"type": 'int', "default": 6, "min": 3, "max": 8, "step": 1, "group": 'Ports', "label": 'Ports sides'},
    "port_r": {"type": 'float', "default": 7.0, "min": 3.5, "max": 9.6, "step": 1.0, "group": 'Ports', "label": 'Ports circumradius (mm)'},
    "port_len": {"type": 'float', "default": 16.8, "min": 3.0, "max": 36.4, "step": 1.0, "group": 'Ports', "label": 'Port boss length (mm)'},
    "port_bore": {"type": 'float', "default": 6.6, "min": 2.0, "max": 8.7, "step": 0.5, "group": 'Ports', "label": 'Port bore diameter (mm)'},
    "hole_d": {"type": 'float', "default": 4.3, "min": 2.0, "max": 9.6, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
