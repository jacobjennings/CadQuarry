...
# Generated by CadQuarry v0.6.0 — seed 1234004004 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 58.7, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 32.2, "min": 12.9, "max": 64.4, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
