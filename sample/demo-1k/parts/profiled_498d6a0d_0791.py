...
# Generated by CadQuarry v0.1.0 — seed 1234004493 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "circ_r": {"type": 'float', "default": 20.76, "min": 10.4, "max": 41.5, "step": 1.0, "group": 'Profile', "label": 'Circumscribed radius (mm)'},
