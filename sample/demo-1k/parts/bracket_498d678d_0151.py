...
# Generated by CadQuarry v0.4.0 — seed 1234003853 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 73.7, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 51.0, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 4.7, "min": 2.5, "max": 11.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
