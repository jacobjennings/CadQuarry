...
# Generated by CadQuarry v0.6.0 — seed 1234003943 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 53.2, "min": 21.3, "max": 106.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
