...
# Generated by CadQuarry v0.6.0 — seed 1234004399 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 17.1, "min": 4.5, "max": 200.0, "step": 1.0, "group": 'Body', "label": 'Block height (mm)'},
    "hole_d": {"type": 'float', "default": 2.5, "min": 2.0, "max": 3.7, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
}
