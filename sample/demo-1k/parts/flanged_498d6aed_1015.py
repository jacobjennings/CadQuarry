...
# Generated by CadQuarry v0.6.0 — seed 1234004717 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 34.94, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 47.2, "min": 14.2, "max": 118.0, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 17.0, "min": 2.0, "max": 24.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 59.9, "min": 45.4, "max": 104.8, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 5.0, "min": 1.5, "max": 18.9, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
