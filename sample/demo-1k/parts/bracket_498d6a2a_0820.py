...
# Generated by CadQuarry v0.4.0 — seed 1234004522 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 50.47, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 8.0, "min": 3.0, "max": 10.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
