...
# Generated by CadQuarry v0.1.0 — seed 1234004157 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 71.4, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 45.74, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 11.1, "min": 4.0, "max": 22.9, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
