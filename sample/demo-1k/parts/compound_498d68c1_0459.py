...
# Generated by CadQuarry v0.4.0 — seed 1234004161 — CC0-1.0
...
PARAMS = {
    ...
    "block_h": {"type": 'float', "default": 59.8, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Body height (mm)'},
    "port_sides": {"type": 'int', "default": 6, "min": 3, "max": 8, "step": 1, "group": 'Ports', "label": 'Ports sides'},
    "port_r": {"type": 'float', "default": 8.5, "min": 4.2, "max": 11.8, "step": 1.0, "group": 'Ports', "label": 'Ports circumradius (mm)'},
    "port_len": {"type": 'float', "default": 11.5, "min": 3.7, "max": 44.2, "step": 1.0, "group": 'Ports', "label": 'Port boss length (mm)'},
    "port_bore": {"type": 'float', "default": 8.9, "min": 2.0, "max": 10.6, "step": 0.5, "group": 'Ports', "label": 'Port bore diameter (mm)'},
