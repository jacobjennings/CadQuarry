...
# Generated by CadQuarry v0.3.0 — seed 1234004619 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 112.64, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 68.5, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 33.8, "min": 22.5, "max": 50.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
