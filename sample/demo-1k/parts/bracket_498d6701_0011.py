...
# Generated by CadQuarry v0.6.0 — seed 1234003713 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 61.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 36.58, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
