...
# Generated by CadQuarry v0.5.0 — seed 1234004723 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "enc_w": {"type": 'float', "default": 100.87, "min": 30.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure width (mm)'},
    ...
    "hole_d": {"type": 'float', "default": 3.2, "min": 2.0, "max": 9.7, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
}
