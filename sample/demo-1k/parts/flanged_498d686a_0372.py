...
# Generated by CadQuarry v0.1.0 — seed 1234004074 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 85.12, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 101.9, "min": 30.6, "max": 254.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 34.7, "min": 2.0, "max": 59.6, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 158.1, "min": 110.7, "max": 255.4, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 8.7, "min": 2.6, "max": 40.8, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
