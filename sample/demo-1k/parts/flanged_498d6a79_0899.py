...
# Generated by CadQuarry v0.4.0 — seed 1234004601 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 101.5, "min": 30.4, "max": 253.8, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 26.0, "min": 2.0, "max": 56.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 167.5, "min": 104.0, "max": 240.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 11.8, "min": 3.5, "max": 40.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
