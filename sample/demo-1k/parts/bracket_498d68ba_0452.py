...
# Generated by CadQuarry v0.1.0 — seed 1234004154 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 52.04, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.7, "min": 3.0, "max": 18.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
