...
# Generated by CadQuarry v0.1.0 — seed 1234004627 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 42.3, "min": 21.1, "max": 60.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 32.4, "min": 16.2, "max": 53.5, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 33.5, "min": 13.4, "max": 85.0, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
