...
# Generated by CadQuarry v0.3.0 — seed 1234004030 — CC0-1.0
...
PARAMS = {
    ...
    "hole_d": {"type": 'float', "default": 3.8, "min": 2.0, "max": 11.8, "step": 0.5, "group": 'Holes', "label": 'Square hole size (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["block_w"], p["block_d"]) * 0.10686751990743787)
    return result
