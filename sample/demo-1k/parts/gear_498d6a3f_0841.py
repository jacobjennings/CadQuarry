...
# Generated by CadQuarry v0.6.0 — seed 1234004543 — CC0-1.0
...
PARAMS = {
    ...
    "helix_angle": {"type": 'float', "default": 29.7, "min": 5.0, "max": 40.0, "step": 1.0, "group": 'Gear', "label": 'Helix angle (deg)'},
    "profile_shift": {"type": 'float', "default": -0.23, "min": -0.5, "max": 0.7, "step": 0.05, "group": 'Gear', "label": 'Profile shift'},
    "root_fillet": {"type": 'float', "default": 0.18, "min": 0.0, "max": 0.62, "step": 0.05, "group": 'Gear', "label": 'Root fillet (mm)'},
    "bore_d": {"type": 'float', "default": 4.6, "min": 2.0, "max": 19.9, "step": 0.5, "group": 'Bore', "label": 'Bore diameter (mm)'},
}
