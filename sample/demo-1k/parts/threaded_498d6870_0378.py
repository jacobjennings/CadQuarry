...
# Generated by CadQuarry v0.6.0 — seed 1234004080 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 60.4, "min": 24.2, "max": 120.8, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
