...
# Generated by CadQuarry v0.6.0 — seed 1234003770 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 54.0, "min": 21.6, "max": 108.0, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
