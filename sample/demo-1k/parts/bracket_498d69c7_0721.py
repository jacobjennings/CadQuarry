...
# Generated by CadQuarry v0.1.0 — seed 1234004423 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 29.55, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 32.5, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 6.2, "min": 3.0, "max": 18.0, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
