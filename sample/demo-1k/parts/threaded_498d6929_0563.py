...
# Generated by CadQuarry v0.6.0 — seed 1234004265 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 36.8, "min": 14.7, "max": 73.6, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
