...
# Generated by CadQuarry v0.1.0 — seed 1234004490 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 73.73, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
...
def build(p):
    ...
    result = (
        ...
        .rarray(59.0, 17.6, p["hole_nx"], p["hole_ny"])
        .hole(p["hole_d"])
    )
    return result
