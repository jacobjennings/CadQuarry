...
# Generated by CadQuarry v0.6.0 — seed 1234004051 — CC0-1.0
...
PARAMS = {
    ...
    "side_tube_d": {"type": 'float', "default": 10.4, "min": 4.2, "max": 22.5, "step": 1.0, "group": 'Side Tube', "label": 'Side tube diameter (mm)'},
    "side_tube_len": {"type": 'float', "default": 16.5, "min": 5.0, "max": 31.2, "step": 1.0, "group": 'Side Tube', "label": 'Side tube length (mm)'},
    "side_bore_d": {"type": 'float', "default": 5.5, "min": 2.0, "max": 7.8, "step": 0.5, "group": 'Side Tube', "label": 'Side bore diameter (mm)'},
}
