...
# Generated by CadQuarry v0.3.0 — seed 1234003759 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 27.6, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "top_len": {"type": 'float', "default": 44.1, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Top flange length (mm)'},
    "hole_d": {"type": 'float', "default": 6.4, "min": 3.0, "max": 6.0, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
