...
# Generated by CadQuarry v0.6.0 — seed 1234003797 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 48.3, "min": 19.3, "max": 96.6, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
