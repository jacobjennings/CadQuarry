...
# Generated by CadQuarry v0.3.0 — seed 1234004785 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 46.3, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 5.5, "min": 3.0, "max": 17.5, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
