...
# Generated by CadQuarry v0.6.0 — seed 1234004291 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 31.8, "min": 15.9, "max": 44.5, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 20.6, "min": 10.3, "max": 27.9, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 5.5, "min": 2.2, "max": 10.2, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.06872706486128291)
    result = (
        result.faces('>Z').workplane()
