...
# Generated by CadQuarry v0.1.0 — seed 1234004472 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 20.6, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 10.4, "min": 4.0, "max": 10.3, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
