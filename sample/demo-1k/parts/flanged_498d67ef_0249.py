...
# Generated by CadQuarry v0.6.0 — seed 1234003951 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 75.95, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 58.2, "min": 17.5, "max": 145.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 27.4, "min": 2.0, "max": 53.2, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 158.0, "min": 98.7, "max": 227.9, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 13.4, "min": 4.0, "max": 23.3, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
