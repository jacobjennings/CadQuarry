...
# Generated by CadQuarry v0.1.0 — seed 1234003986 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 8.6, "min": 4.3, "max": 16.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 6.8, "min": 3.4, "max": 11.5, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 6.0, "min": 2.4, "max": 11.6, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
