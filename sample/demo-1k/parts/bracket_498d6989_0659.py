...
# Generated by CadQuarry v0.3.0 — seed 1234004361 — CC0-1.0
...
PARAMS = {
    ...
    "bracket_w": {"type": 'float', "default": 40.86, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    ...
    "gusset_t": {"type": 'float', "default": 7.8, "min": 4.0, "max": 20.4, "step": 0.5, "group": 'Gusset', "label": 'Gusset thickness (mm)'},
