...
# Generated by CadQuarry v0.4.0 — seed 1234003831 — CC0-1.0
...
PARAMS = {
    ...
    "vert_len": {"type": 'float', "default": 51.4, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
