...
# Generated by CadQuarry v0.6.0 — seed 1234003997 — CC0-1.0
...
PARAMS = {
    ...
    "pocket_w": {"type": 'float', "default": 42.5, "min": 21.2, "max": 60.0, "step": 1.0, "group": 'Pocket', "label": 'Pocket width (mm)'},
    "pocket_d": {"type": 'float', "default": 41.7, "min": 20.9, "max": 48.2, "step": 1.0, "group": 'Pocket', "label": 'Pocket depth (mm)'},
    "pocket_h": {"type": 'float', "default": 22.9, "min": 9.2, "max": 56.9, "step": 0.5, "group": 'Pocket', "label": 'Pocket height (mm)'},
}
