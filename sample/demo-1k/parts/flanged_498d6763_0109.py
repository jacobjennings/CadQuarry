...
# Generated by CadQuarry v0.1.0 — seed 1234003811 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 57.7, "min": 17.3, "max": 144.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 26.4, "min": 2.0, "max": 35.0, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 106.5, "min": 65.0, "max": 150.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 6.1, "min": 1.8, "max": 23.1, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
