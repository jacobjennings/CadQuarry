...
# Generated by CadQuarry v0.6.0 — seed 1234004708 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 88.99, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 128.2, "min": 38.5, "max": 320.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 27.5, "min": 2.0, "max": 62.3, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 161.2, "min": 115.7, "max": 267.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 8.8, "min": 2.6, "max": 51.3, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
