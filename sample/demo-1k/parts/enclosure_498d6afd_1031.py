...
# Generated by CadQuarry v0.4.0 — seed 1234004733 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 38.1, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 50.0, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
