...
# Generated by CadQuarry v0.6.0 — seed 1234003879 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 62.2, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 81.3, "min": 32.5, "max": 162.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
