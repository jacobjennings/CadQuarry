...
# Generated by CadQuarry v0.6.0 — seed 1234004060 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 71.9, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 45.3, "min": 18.1, "max": 90.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
