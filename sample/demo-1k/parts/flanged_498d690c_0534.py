...
# Generated by CadQuarry v0.6.0 — seed 1234004236 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 24.99, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 19.4, "min": 5.8, "max": 48.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 12.4, "min": 2.0, "max": 17.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 52.3, "min": 32.5, "max": 75.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 3.2, "min": 1.0, "max": 7.8, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
