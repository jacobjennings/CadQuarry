...
# Generated by CadQuarry v0.5.0 — seed 1234004413 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "outer_d": {"type": 'float', "default": 97.07, "min": 20.0, "max": 100.0, "step": 1.0, "group": 'Body', "label": 'Outer diameter (mm)'},
    "length": {"type": 'float', "default": 71.0, "min": 21.3, "max": 177.5, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 48.7, "min": 2.0, "max": 67.9, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 186.7, "min": 126.2, "max": 291.2, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 16.3, "min": 4.9, "max": 28.4, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
