...
# Generated by CadQuarry v0.1.0 — seed 1234004706 — CC0-1.0
...
PARAMS = {
    ...
    "base_d": {"type": 'float', "default": 54.1, "min": 15.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base depth (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 9.6, "min": 3.8, "max": 19.2, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
