...
# Generated by CadQuarry v0.3.0 — seed 1234003949 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "plate_w": {"type": 'float', "default": 100.41, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate width (mm)'},
    "plate_d": {"type": 'float', "default": 91.9, "min": 8.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Plate depth (mm)'},
    ...
    "bolt_r": {"type": 'float', "default": 30.1, "min": 20.1, "max": 45.2, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
...
def build(p):
    ...
    if p["filleted"]:
        result = result.edges('|Z').fillet(min(p["plate_w"], p["plate_d"]) * 0.10702537993157796)
    return result
