...
# Generated by CadQuarry v0.4.0 — seed 1234004625 — CC0-1.0
...
PARAMS = {
    ...
    "enc_d": {"type": 'float', "default": 50.0, "min": 12.0, "max": 120.0, "step": 1.0, "group": 'Body', "label": 'Enclosure depth (mm)'},
    "enc_h": {"type": 'float', "default": 74.3, "min": 29.7, "max": 148.6, "step": 1.0, "group": 'Body', "label": 'Enclosure height (mm)'},
