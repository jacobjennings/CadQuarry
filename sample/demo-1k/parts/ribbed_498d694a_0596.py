...
# Generated by CadQuarry v0.4.0 — seed 1234004298 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_w": {"type": 'float', "default": 76.34, "min": 20.0, "max": 120.0, "step": 1.0, "group": 'Base', "label": 'Base width (mm)'},
    ...
    "rib_h": {"type": 'float', "default": 18.5, "min": 7.4, "max": 37.0, "step": 1.0, "group": 'Ribs', "label": 'Rib height (mm)'},
