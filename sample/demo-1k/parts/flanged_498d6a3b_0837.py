...
# Generated by CadQuarry v0.4.0 — seed 1234004539 — CC0-1.0
...
PARAMS = {
    ...
    "length": {"type": 'float', "default": 78.9, "min": 23.7, "max": 197.2, "step": 1.0, "group": 'Body', "label": 'Length (mm)'},
    "inner_d": {"type": 'float', "default": 24.3, "min": 2.0, "max": 38.5, "step": 0.5, "group": 'Body', "label": 'Bore diameter (mm)'},
    "flange_d": {"type": 'float', "default": 119.3, "min": 71.5, "max": 165.0, "step": 1.0, "group": 'Flange', "label": 'Flange diameter (mm)'},
    "flange_h": {"type": 'float', "default": 9.2, "min": 2.8, "max": 31.6, "step": 0.5, "group": 'Flange', "label": 'Flange height (mm)'},
    "bolt_d": {"type": 'float', "default": 4.3, "min": 3.0, "max": 13.0, "step": 0.1, "group": 'Holes', "label": 'Bolt hole diameter (mm)'},
    "bolt_r": {"type": 'float', "default": 35.8, "min": 23.9, "max": 53.7, "step": 1.0, "group": 'Holes', "label": 'Bolt circle radius (mm)'},
