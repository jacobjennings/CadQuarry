...
# Generated by CadQuarry v0.3.0 — seed 1234003812 — CC0-1.0
# https://github.com/jacobjennings/CadQuarry

PARAMS = {
    "base_len": {"type": 'float', "default": 75.84, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Base leg length (mm)'},
    "vert_len": {"type": 'float', "default": 46.8, "min": 25.0, "max": 90.0, "step": 1.0, "group": 'Body', "label": 'Vertical leg length (mm)'},
    "bracket_w": {"type": 'float', "default": 19.4, "min": 15.0, "max": 60.0, "step": 1.0, "group": 'Body', "label": 'Width (mm)'},
    "bracket_t": {"type": 'float', "default": 8.0, "min": 3.0, "max": 8.0, "step": 0.5, "group": 'Body', "label": 'Thickness (mm)'},
    "hole_d": {"type": 'float', "default": 3.2, "min": 3.0, "max": 7.8, "step": 0.1, "group": 'Holes', "label": 'Hole diameter (mm)'},
