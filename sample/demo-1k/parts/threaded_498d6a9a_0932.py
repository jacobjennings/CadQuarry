...
# Generated by CadQuarry v0.6.0 — seed 1234004634 — CC0-1.0
...
PARAMS = {
    ...
    "thread_len": {"type": 'float', "default": 41.2, "min": 16.5, "max": 82.4, "step": 1.0, "group": 'Thread', "label": 'Thread length (mm)'},
}
