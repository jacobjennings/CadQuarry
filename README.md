...
```
dataset/
├── manifest.jsonl            one JSON record per part (id, family, tier, signature, descriptor, paths)
...
├── meta/{id}.meta.json       provenance: seed, family, tier, geometry signature, descriptor
